...
def insertar_usuario(nombre, email, contrasena, fecha,ultima_conexion):
    """
    ...
    try:
        ...
        query = """
        INSERT INTO usuarios (nombre, email, contrasena, fecha, ultima_conexion)
        VALUES (%s, %s, %s, %s, %s)
        """

        # Ejecutar la consulta pasando los valores como parámetros
        cursor.execute(query, (nombre, email, contrasena, fecha, ultima_conexion))
